...
class NorcLowConsentBatch {
    ...
    static constraints = {
		...
		dobMo(nullable:true)
		dobMoCodes(nullable:true)
		dobDy(nullable:true)
		dobDyCodes(nullable:true)
		dobYr(nullable:true)
		dobYrCodes(nullable:true)
		psuId(nullable:true)
		agecalc(nullable:true)
		timeStamp1(nullable:true)
		currmo(nullable:true)
		currdy(nullable:true)
		curryr(nullable:true)
		quexver(nullable:true)
		quexlang(nullable:true)
		sameday(nullable:true)
		...
		whoConsented(nullable:true)
		cn004c(nullable:true)
		timeStamp2a(nullable:true)
		consentComments(nullable:true)
		cn006(nullable:true)
		cn006a(nullable:true)
		timeStamp3(nullable:true)
		consentDate(nullable:true)
		english(nullable:true)
		contactLang(nullable:true)
		contactLangOth(nullable:true)
		contactLangOthCodes(nullable:true)
		interpret(nullable:true)
		contactInterpret(nullable:true)
		contactInterpretOth(nullable:true)
		disp(nullable:true)
